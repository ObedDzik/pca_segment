...
# unetr_preds/dicefocal"
#     save_lesionmeasures_dir = "/data/blobfuse/PSMA_PCA_LESIONS_SEGMENTATION/data_resampled_results/\
...
test_predictions/sammed_preds/fold1/diceloss"
    save_lesionmeasures_dir = "/data/blobfuse/PSMA_PCA_LESIONS_SEGMENTATION/data_resampled_results/\
single_fold_results/sammed/fold1model/diceloss"

    # preddir = os.path.join(RESULTS_FOLDER, 'predictions', f'fold{fold}', network, experiment_code)
    preddir = RESULTS_FOLDER
    
    # preddir = "/data/blobfuse/PSMA_PCA_LESIONS_SEGMENTATION/data_resampled_results/test_predictions/attunet_preds/L1ghdlfocal/ensemble_results"
    # save_lesionmeasures_dir = "/data/blobfuse/PSMA_PCA_LESIONS_SEGMENTATION/data_resampled_results/test_predictions/attunet_preds/L1ghdlfocal"
    
#     fold=1
#     preddir = "/data/blobfuse/PSMA_PCA_LESIONS_SEGMENTATION/data_resampled_results/\
# validation_predictions/segresnet/fold1/diceloss/predictions/fold1/segresnet/segresnet_fold1_randcrop128/" 
#     save_lesionmeasures_dir = "/data/blobfuse/PSMA_PCA_LESIONS_SEGMENTATION/data_resampled_results/validation_predictions/segresnet/fold1/diceloss"
    
    os.makedirs(save_lesionmeasures_dir, exist_ok=True)
    filepath = os.path.join(save_lesionmeasures_dir, f'testlesionmeasures.csv')
    
    
    # predpaths = sorted(glob(os.path.join(preddir, '*_seg.nii.gz')))
    ...
    # save_lesionmeasures_dir = "/data/blobfuse/PSMA_PCA_LESIONS_SEGMENTATION/data_resampled_results/test_predictions/segresnet_preds/dice_ce/"
    # os.makedirs(save_lesionmeasures_dir, exist_ok=True)
    # filepath = os.path.join(save_lesionmeasures_dir, f'testlesionmeasures.csv')
