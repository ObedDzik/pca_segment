...
def get_results_folder(args):
    if args.loss_fxn == "L1ghdl":
        RESULTS_FOLDER = "/data/blobfuse/MULTITRACER_DATASET/results/L1ghdlfocal_results"
    elif args.loss_fxn == "dice_ce":
...
def main(args):
    #Set directory where results should be stored for the models
    RESULTS_FOLDER = get_results_folder(args)
...
if __name__ == "__main__": 
    ...
    parser.add_argument('--loss-fxn', type=str, default='dicefocal', metavar='lossfxn',
                        help='loss function for training (default: dicefocal)')
    ...
    parser.add_argument('--rank', type=str, default="0", metavar='rank',
                        help='rank of the cuda device')
